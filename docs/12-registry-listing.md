...
```markdown
- [@momus/mcp-server](https://github.com/AraneaDev/Momus-MCP) - Unsparing mock and test integrity auditor for TypeScript, PHP, Python, and Rust coding agents. Detects test contract drift and tautological assertions statically.
```
