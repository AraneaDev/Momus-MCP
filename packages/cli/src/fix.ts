/** `momus audit --fix` mechanics (docs/01 §1.5): collect, diff, and apply rule-emitted fixes.
 *  The write path is the one sanctioned CLI write — gated by `--yes` and refused in CI. */
